...
@WebServlet(name = "ChildrenBookServlet", value = "/ChildrenBookServlet")
public class ChildrenBookServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        BooksDao daoBooks = new BooksDao();

        request.setAttribute("group", daoBooks.searchChildren());
